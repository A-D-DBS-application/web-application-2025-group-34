...
class Config: 
    ...
    # Upload configuration (alleen voor validatie, files worden opgeslagen in Supabase)
    MAX_CONTENT_LENGTH = 500 * 1024 * 1024  # 500MB max file size
    ALLOWED_EXTENSIONS = {'zip', 'pdf', 'doc', 'docx', 'xls', 'xlsx', 'txt', 'png', 'jpg', 'jpeg', 'gif'}
    
    # UPLOAD_FOLDER verwijderd - alle files worden nu opgeslagen in Supabase storage
